    ...
    return (
        <>
            <div className={`${isDark ? 'dark-theme' : 'light-theme'} nammaCompilerEnterTitle`}>
                <input type='text' placeholder='Enter Title (will be available when the `save` will be functional)' className={`${isDark ? 'dark-theme' : 'light-theme'} nammaCompilerEnterTitleInput`} />
            </div >
        </>
    );
};
